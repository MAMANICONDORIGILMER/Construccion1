...
<html>
  ...
  <body>
    ...
    <section class="login-content">
      ...
      <div class="login-box">
        <form class="login-form" action="/recuperar/ver" method="POST">
          <h3 class="login-head">Recuperar Contraseña</h3>
          <div class="form-group">
            <label class="control-label">Correo</label>
            <input class="form-control" name="TxtCorreo" type="text" placeholder="Correo" value="{{ old('TxtCorreo') }}" required autofocus>
          </div>
          <div class="form-group btn-container">
          <input type="hidden" name="_token" value="{{ csrf_token() }}">
            <button class="btn btn-primary btn-block"><i class="fa fa-sign-in fa-lg fa-fw"></i>Enviar Correo</button>
          </div>
        </form>
      </div>
